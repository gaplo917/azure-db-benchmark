  ...
  await runBenchmark(
    ...
    async pool => {
      ...
      const jobMap = new Map([
        ...
        [
          1,
          () => [[ReadQueries.query1SQL, ReadQueries.query1Params(numOfQuerySet, Number(count))]]
        ],
        [
          2,
          () => [[ReadQueries.query2SQL, ReadQueries.query2Params(numOfQuerySet, Number(count))]]
        ],
        [
          3,
          () => [[ReadQueries.query3SQL, ReadQueries.query3Params(numOfQuerySet, Number(count))]]
        ],
        [
          4,
          () => [[ReadQueries.query4SQL, ReadQueries.query4Params(numOfQuerySet, Number(count))]]
        ],
